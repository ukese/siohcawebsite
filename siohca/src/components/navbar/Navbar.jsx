  ...
  return (
    ...
    <div className='siohca-navbar'>
        ...
        <div className='siohca-navbar-links_container'>
          <p><NavLink to="/team" className={({ isActive }) => isActive ? "active-navbar-link" : undefined}>
            Team
            </NavLink>
          </p>
          <p> 
            <NavLink to="/posts"  className={({ isActive }) => isActive ? "active-navbar-link" : undefined}>
              Posts
            </NavLink>
          </p>
          <p>
          ...
          <p>
            <NavLink to="/contacts" className={({ isActive }) => isActive ? "active-navbar-link" : undefined}>
              Contacts
            </NavLink>
          </p>
        </div>
        ...
        <div className="siohca-navbar-menu-icon" onClick={toggleMenu}>
          <div className='vscmenu'><VscMenu/></div> 
          <div className='vscclose'><VscClose/></div>
        </div>
      </div>
      <div className="siohca-navbar-menu">
        <p><Link to="/team">Team</Link></p>
          ...
          <p><Link to="/publications&press">Publications & Press</Link></p>
