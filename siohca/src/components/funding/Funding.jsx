      ...
      <div className="funding">
        ...
        <div className="funding-box-row margin-bottom-1">
          <p>
            ...
            <b> University of Maribor Faculty of Medicine </b> for 4 months
            between 1st of March and 30th of June 2022.
          </p>
        </div>
        <div className="funding-box-row margin-bottom-2">
          <p>
            It is currently cofinanced by <b>the Republic of Slovenia</b> and{" "}
            <b>the European Social Fund</b>.
          </p>
        </div>
        <div className="funding-logos">
          <div className="funding-logos-item" id="um">
            <UM />
          </div>
          <div className="funding-logos-item">
            <ESS />
          </div>
          <div className="funding-logos-item">
            <MIZS />
