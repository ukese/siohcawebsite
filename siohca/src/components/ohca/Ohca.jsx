...
import img1 from  '../../assets/svg/social-media-marketing-growth.png'
            ...
            <div className='ohca-box-text'>
              <Fade bottom delay={200}>
                <div className="box" id='text1'>
                  <p><b>Out-of-hospital cardiac arrest</b> (OHCA) describes the loss of <b>mechanical cardiac function</b> and the <b>absence of systemic circulation</b>. </p>
                </div>
              </Fade>
              <Fade bottom delay={200}>
