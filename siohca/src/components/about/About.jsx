    ...
    <div className="about-siohca">
      <div className="column-box">
        ...
        <p className="margin-bottom-1">
          Interdisciplinary student project run by University of Maribor Faculty
          of medicine. Our goal is to develop an open-source software to help
          track and analyse OHCA.
        </p>

        <p className="margin-bottom-2">
          In depth documentation can be found on our{" "}
        </p>
